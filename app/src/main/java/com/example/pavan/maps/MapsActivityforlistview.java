...
public class MapsActivityforlistview extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps_activityforlistview);
    ...
    public void onMapReady(GoogleMap googleMap) {
       ...
       /* LatLng sydney = new LatLng(-34, 151);
        ...
        int i=finalpage.listposmap;
        LatLng x=DijkstrasAlgorithm.mappoints.get(i);
        mMap.addMarker(new MarkerOptions().position(x).icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_place_black_24dp)).title("Marker in "+DijkstrasAlgorithm.pathString.get(i)));
